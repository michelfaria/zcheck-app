---
title: "Como aprovar solicitações e gerenciar usuários"
...
Quando alguém [solicita acesso](/ajuda/primeiros-passos/como-solicitar-acesso), o pedido aparece em **Solicitações pendentes**:

1. Abra a solicitação: você vê nome, CPF, telefone, e-mail e a **selfie** enviada — confirme que é a pessoa certa.
2. Defina o **papel** (colaborador, liderança, gerência ou diretoria), a **loja** e, se quiser, o **setor**.
...
Pedidos feitos pela equipe no ícone **⚙️** do app (trocar nome, telefone, PIN, setor…) chegam na mesma tela, marcados como alteração de dados. Revise e aprove do mesmo jeito.
