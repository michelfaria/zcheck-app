---
title: "Passou do prazo — e agora?"
description: "O que significa o status Atrasado, se ainda dá para executar e como o atraso aparece para a gestão."
category: usando-checklists
order: 7
updatedAt: "2026-07-20"
---

Alguns checklists têm **prazo** (por exemplo, Abertura até 09:00). Passou da hora e ele não foi concluído? O status vira **Atrasado**, em vermelho.

## Ainda dá para executar?

**Sim — e deve.** Atrasado não é bloqueado: abra o checklist e execute normalmente. Concluir atrasado é muito melhor do que não concluir: as tarefas são feitas, e o registro fica completo.
...
1. Priorize os checklists com prazo logo no início do turno.
